...
function page(title, verdict, scope, body) {
  ...
  </style><main><header><div class="eyebrow">MidBrain / behavioral testing</div><h1>${esc(title)}</h1>${badge(verdict)}<p class="scope">${esc(scope)}</p></header>${body}<footer>Offline results summary. Raw transcripts and credential-bearing test homes are not embedded. Reported client costs are not a provider invoice and exclude unreported usage, runner and backend costs.</footer></main></html>`;
}
